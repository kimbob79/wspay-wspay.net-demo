			...
			<div id="content">
				<div class="receipt_section">
					...
					<ul class="detail_list">
						...
						<li><strong class="item_title">승인번호</strong><span class="point_color_green"><?php echo $row['pay_num']; ?></span></li>
						...
						*/ ?>
						...
						?>
						<li><strong class="item_title">상품명</strong><?php echo $row2['goodsName']; ?></li>
						<li><strong class="item_title">구매자명</strong><?php echo $row2['customerName']; ?></li>
						<?php } ?>
					</ul>
					...
					<ul class="detail_list">
						...
						<li><strong class="item_title">전화번호</strong><?php echo $pgc_tel; ?></li>
