<?php
	...
	$rowurl = sql_fetch(" select * from pay_payment_url where urlcode = '{$urlcode}' ");
...
<section id="bo_w">
	<input type="hidden" name="mb_id" id="mb_id" value="<?php echo $rowurl['mb_id']; ?>">
	<input type="hidden" name="urlcode" id="urlcode" value="<?php echo $urlcode; ?>">
	<div class="tbl_fbasic">
		...
		*/ ?>
		<div style="padding:20px; border:1px solid #aaa; margin-bottom:10px">
		<table class="tbl_form1" style="width:100%;border-collapse: collapse; border-spacing: 0 5px; font-size:13px;">
			<tr>
				<td style="padding:10px; width:110px; font-weight:bold;">상품명</td>
				<td style="padding:10px;"><?php echo $rowurl['url_pd']; ?></td>
			</tr>
			<tr>
				<td style="padding:10px; width:100px; font-weight:bold; border-top:1px solid #aaa">상품금액</td>
				<td style="padding:10px; border-top:1px solid #aaa"><?php echo number_format($rowurl['url_price']); ?>원</td>
			</tr>
			<tr>
				<td style="padding:10px; width:100px; font-weight:bold; border-top:1px solid #aaa">판매자명</td>
				<td style="padding:10px; border-top:1px solid #aaa"><?php echo $rowurl['url_pname']; ?></td>
			</tr>
			<tr>
				<td style="padding:10px; width:100px; font-weight:bold; border-top:1px solid #aaa">판매자 전화번호</td>
				<td style="padding:10px; border-top:1px solid #aaa"><?php echo $rowurl['url_ptel']; ?></td>
			</tr>
			<?php if($rowurl['url_pcontent']) { ?>
			<tr>
				<td style="padding:10px; width:100px; font-weight:bold; border-top:1px solid #aaa">상품설명</td>
				<td style="padding:10px; border-top:1px solid #aaa"><?php echo $rowurl['url_pcontent']; ?></td>
			</tr>
			<?php } ?>
			<?php if($rowurl['url_tec']) { ?>
			<tr>
				<td style="padding:10px; width:100px; font-weight:bold; border-top:1px solid #aaa">상품비고</td>
				<td style="padding:10px; border-top:1px solid #aaa"><?php echo $rowurl['url_tec']; ?></td>
			</tr>
			<?php } ?>
		</table>
		<input type="hidden" name="pd_name" readonly value="<?php echo $rowurl['url_pd']; ?>" id="pd_name" class="full_input frm_input" maxlength="50" placeholder="상품명 사업자특성에 맞게 정확히 입력해주세요">
		<input type="hidden" name="pd_price" readonly value="<?php echo number_format($rowurl['url_price']); ?>" id="pd_price" class="frm_input" placeholder="결제금액" maxlength="8" oninput="maxLengthCheck(this)" style="width:150px;">
		<input type="hidden" name="payments" readonly value="<?php echo $rowurl['url_payments']; ?>" id="payments" class="frm_input" placeholder="결제타입" maxlength="8" oninput="maxLengthCheck(this)" style="width:150px;">
		</div>

		<button class="btn_submit" id="payviewbtn" onclick="payview();">결제 시작하기</button>

		<div style="display:none;" id="payview">
			<table style="width:100%;border-collapse: collapse; border-spacing: 0 5px;">
				...
				<tr><td style="height:8px"></td></tr>
				<tr><td style="font-size:11px; color:#777;">비밀번호 (※ 카드비밀번호 앞2자리)</td></tr>
				<tr><td style="height:4px"></td></tr>
				<tr>
					<td>
				...
				<tr><td style="height:8px"></td></tr>
				<tr><td style="font-size:11px; color:#777;">생년워일</td></tr>
				<tr><td style="height:4px"></td></tr>
				<tr>
					<td>
						...
						<div style="margin-top:10px;font-size:11px;">※ <strong>개인</strong> : 생년월일 6자리 | <strong>법인</strong> : 사업자 10자리</div>
					</td>
				</tr>
				<?php /*
