...
*/ ?>
				...
				<tr><td style="height:5px"></td></tr>
				<tr>
					<td><input type="text" name="pd_name" value="<?php echo $pd_name; ?>" id="pd_name" class="full_input frm_input" maxlength="50" placeholder="상세 상품정보 50자 이내"></td>
				</tr>
				<tr><td style="height:5px"></td></tr>
				<tr>
					<td><input type="number" name="pd_price" value="<?php echo $pd_price; ?>" id="pd_price" class="frm_input pd_price" placeholder="<?php echo number_format($config['cf_1']); ?>원 이하" maxlength="7" oninput="maxLengthCheck(this)" style="width:150px;"> 원
					</td>
				</tr>
				<tr><td style="height:5px"></td></tr>
...
function getPage() {
	...
	} else if(fn(pd_price) > <?php echo $config['cf_1']; ?> ){
		alert("<?php echo number_format($config['cf_1']); ?>원 이하 결제가능합니다.");
		$("#btn_submit").show();
		$("#pd_price").focus();
		return;
	}
