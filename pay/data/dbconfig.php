...
define('G5_MYSQL_PASSWORD', 'q102938Q!@!@!@');
define('G5_MYSQL_DB', 'mpchosting');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'pay_');

define('G5_TOKEN_ENCRYPTION_KEY', '5cb2eca7a13e085d900028428549bf70'); // 토큰 암호화에 사용할 키
...
define('G5_SHOP_TABLE_PREFIX', 'pay_shop_');
