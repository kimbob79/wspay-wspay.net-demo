...
<form name="fmember" id="fmember" action="./?p=deposit_payment_update" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data">
	...
	<table class="table_view">
		<tbody>
			...
			<tr>
				<th style="width:100px"><label for="mb_id">입금액</label></th>
				<td><input type="text" name="deposit" id="deposit" required> <label><input type="checkbox" id="all" value="<?php echo preg_replace("/[^0-9]/","",$row['mb_6_pay']); ?>"> 전체</label></td>
			</tr>
		</tbody>
	</table>
