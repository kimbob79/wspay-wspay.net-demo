					...
					<div class="KDC_Column__root__NK8XY KDC_Column__flex_1__UcocY">
						<div class="KDC_Section__root__VXHOv">
							...
							<tr<?php echo $bgcolor?" style='background: $bgcolor;'":'';?>>
								<td><?php echo $num; ?></td>
								<td class="td_name"><strong><?php echo $row['mchtId']; ?></strong></td>
								...
								<td class="td_pay"><?php echo number_format($row['amount']); ?></td>
								<td><?php echo $row['rootTrxId']; ?></td>
								<td><?php echo $row['datetime']; ?></td>
								<td>
									<div class="buttons">
										<button  class="KDC_Button__root__N26ep KDC_Button__mini__Sy8ka KDC_Button__color_delete__bAeWl" onclick="payment_new('<?php echo $row['trxId']; ?>', '<?php echo $row['trackId'];?>')" type="button">등록</button>
									</div>
								</td>
							</tr>
							<?php } ?>
