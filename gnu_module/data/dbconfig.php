...
define('G5_MYSQL_HOST', '49.247.4.197:3306');
define('G5_MYSQL_USER', 'root');
define('G5_MYSQL_PASSWORD', 'Dohyun070312*');
define('G5_MYSQL_DB', 'mpchosting');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('cssjs', "20251205v2");

define('G5_TOKEN_ENCRYPTION_KEY', '1fc22e32bd46926d38870c87a2815c3e'); // 토큰 암호화에 사용할 키
