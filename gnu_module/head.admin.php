...
<meta property="og:title" content="카드정산닷컴">
<meta property="og:description" content="카드정산닷컴">
<?php
if (G5_IS_MOBILE) {
...
if (defined('G5_IS_ADMIN')) {
    if(!defined('_THEME_PREVIEW_'))
        echo '<link rel="stylesheet" href="'.run_replace('head_css_url', '/new4/css/admin.css?ver='.time(), G5_URL).'">'.PHP_EOL;
} else {
    $shop_css = '';
