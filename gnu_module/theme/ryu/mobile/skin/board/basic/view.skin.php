...
<article id="bo_v" style="width:<?php echo $width; ?>">
	...
	<div id="bo_btn">
		<div id="bo_v_option">
		    ...
		    <ul id="bo_v_opt">
		    	<?php ob_start(); ?>
				<?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b btn_b02">수정</a></li><?php } ?>
		    	<?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;" class="btn_b btn_b10">삭제</a></li><?php } ?>
		    	<?php if ($copy_href) { ?><li><a href="<?php echo $copy_href ?>" onclick="board_move(this.href); return false;" class="btn_b btn_b06">복사</a></li><?php } ?>
		    	<?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" onclick="board_move(this.href); return false;" class="btn_b btn_b06">이동</a></li><?php } ?>
		...
		<div class="btn_top top">
			<a href="<?php echo $list_href ?>" class="btn_b btn_b02"> 목록</a>
	        <?php if ($reply_href) { ?><a href="<?php echo $reply_href ?>" class="btn_b btn_b04">답변</a><?php } ?>
	        <?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn_b btn_b02">글쓰기</a><?php } ?>
		</div>
	</div>
