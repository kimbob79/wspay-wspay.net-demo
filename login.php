		...
		<div class="login-card">
			...
			<form action="./login_check.php" method="post" class="login-form">
				...
				<div class="input-group">
					<input type="text" name="mb_id" placeholder="아이디를 입력하세요" required autocomplete="off">
				...
				<div class="input-group">
					<input type="password" name="mb_password" id="pw_box" placeholder="패스워드를 입력하세요" required autocomplete="off">
					<div class="input-icon">
						<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
