		...
		<div class="top">
			<div class="inner">
				<table class="table_pg">
					...
					<tr>
						<th>업종</th>
						<td><?php echo $mb['mb_email_certify2']; ?></td>
						<th>업태</th>
						<td><?php echo $mb['mb_lost_certify']; ?></td>
					</tr>
					<tr>
						<th>한도</th>
				...
				<div class="write-form">
					...
					*/ ?>
					<form name="insert_bbs_form" method=post enctype="multipart/form-data" action="./payment_update.php" onsubmit="return false;">
						...
						<input type="hidden" name="mb_id" id="mb_id" value="<?php echo $member['mb_id']; ?>" style='background:#222;color:#fff;'>

						<?php if($member_pg['pg_key1']) { ?>
						<input type="hidden" name="pg_key1" id="pg_key1" value="<?php echo $member_pg['pg_key1']; ?>" style='background:#222;color:#fff;'>
						<?php } ?>

						<?php if($member_pg['pg_key2']) { ?>
						<input type="hidden" name="pg_key2" id="pg_key2" value="<?php echo $member_pg['pg_key2']; ?>" style='background:#222;color:#fff;'>
						<?php } ?>

						<?php if($member_pg['pg_key3']) { ?>
						<input type="hidden" name="pg_key3" id="pg_key3" value="<?php echo $member_pg['pg_key3']; ?>" style='background:#222;color:#fff;'>
						<?php } ?>

						<?php if($member_pg['pg_key4']) { ?>
						<input type="hidden" name="pg_key4" id="pg_key4" value="<?php echo $member_pg['pg_key4']; ?>" style='background:#222;color:#fff;'>
						<?php } ?>

						<?php if($member_pg['pg_key5']) { ?>
						<input type="hidden" name="pg_key5" id="pg_key5" value="<?php echo $member_pg['pg_key5']; ?>" style='background:#222;color:#fff;'>
						<?php } ?>
						...
						<fieldset>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<input type="text" name="pay_product" id="pay_product" class="form-control" maxlength="20" placeholder="상품명" value="<?php echo $pay_product; ?>" required>
								</div>
							</div>
							...
							<div class="panel">
								...
								<div class="panel-body">
									<input type="text" name="pay_price" id="pay_price" class="form-control" placeholder="결제금액" value="<?php echo $pay_price; ?>" maxlength="10" required onkeyup="inputNumberFormat(this);">
								</div>
							</div>
					...
					<ul>
						<li>
							<label for="agreeTerm" class="input-chk">
								<input type="checkbox" name="agreeTerm" id="agreeTerm" value="1" data-role="none"> <span>이용약관 동의</span>
							</label>
