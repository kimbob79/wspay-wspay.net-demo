<?php
	...
	if($payments == "k1") { // 광원 구인증


		// 광원 결제
		function pay_ko($payerName, $payerEmail, $payerTel, $number, $expiry, $cardAuth, $authPw, $authDob, $installment, $pd_name, $pd_price, $tmnId, $keydata, $trackId, &$http_status, &$header = null) {
		...
		$ret = pay_ko($pay_pname, $pay_email, $pay_phone, $pay_cardnum, $pay_YM, $cardAuth, $pay_password, $pay_certify, $pay_installment, $pay_product, $pay_price, $pg_key1, $pg_key2, $trackId, $http_status);
