...
$comment_action_url = "./board_view_comment_update.php";
...
<section id="bo_vc">
	...
	<article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
		...
		<?php if ($list[$i]['is_edit']) { ?><a href="#cu" onclick="comment_box('<?php echo $comment_id ?>', 'cu'); return false;" class="btn-black btn-xm">수정</a><?php } ?>
...
<aside id="bo_vc_w" class="bo_vc_w">
	...
	<input type="hidden" name="w" value="<?php echo $w ?>" id="w" style="border:1px solid #000">
	<input type="hidden" name="bo_table" value="<?php echo $pp ?>" style="border:1px solid #000">
	<input type="hidden" name="wr_id" value="<?php echo $wr_id ?>" style="border:1px solid #000">
	<input type="hidden" name="comment_id" value="<?php echo $c_id ?>" id="comment_id" style="border:1px solid #000">
	<input type="hidden" name="sca" value="<?php echo $sca ?>" style="border:1px solid #000">
	<input type="hidden" name="sfl" value="<?php echo $sfl ?>" style="border:1px solid #000">
	<input type="hidden" name="stx" value="<?php echo $stx ?>" style="border:1px solid #000">
	<input type="hidden" name="spt" value="<?php echo $spt ?>" style="border:1px solid #000">
	<input type="hidden" name="page" value="<?php echo $page ?>" style="border:1px solid #000">
	<input type="hidden" name="is_good" value="" style="border:1px solid #000">
