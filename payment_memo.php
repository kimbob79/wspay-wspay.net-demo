<?php
	...
	$sql_common = " from g5_payment_memo a left join g5_payment b on a.pay_id = b.pay_id";
		...
		<table class="table_list td_pd">
			...
			<tbody>
				...
				<tr class='<?php echo $bgcolor; ?>'>
					...
					<td style="text-align:center;"><button  class="btn_b <?php echo $memo_class; ?>" onclick="payment_memo('<?php echo $row['pay_id'];?>')" type="button">메모 <?php echo $memo_count; ?></button></td>
					<td style="text-align:left;"><?php echo $row['me_memo']; ?></td>
					<td style="text-align:center;"><?php echo $row['mb_name']; ?></td>
