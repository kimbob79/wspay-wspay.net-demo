...
if($CPID) {
	...
	/******** 카정으로 전송 ************/
	$data = array('QUOTA' => $QUOTA, 'TRANTIME' => $TRANTIME, 'CARDNAME' => $CARDNAME, 'TXTYPE' => $TXTYPE, 'TID' => $TID, 'TRANDATE' => $TRANDATE, 'ORDERID' => $ORDERID, 'CAT_ID' => $CAT_ID, 'AMOUNT' => $AMOUNT, 'CPID' => $CPID, 'CARDAUTHNO' => $CARDAUTHNO, 'O_TID' => $O_TID, 'ITEMNAME' => $ITEMNAME, 'CATID' => $CATID, 'CARDNO' => $CARDNO);
