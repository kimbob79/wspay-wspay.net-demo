...
// 취소일경우 TAX 원거래
if($pay_type == 'N') {
	$ori = sql_fetch("select * from g5_tax where pay_num = '{$authCd}' and trxid = '{$rootTrxId}' ", $DBC);
}
...
if($noError == false) {
	...
	sendfcm('4', '에러', '문제가 있습니다', '01099895231');
}
?>