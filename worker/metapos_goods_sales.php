<?php
/**
 * MetaPOS API - 상품 매출 조회
 * URL: https://webapi.metapos.co.kr/webapi/sales_search/api/goodsSales.asp
 */

// API 설정
$api_url = "https://webapi.metapos.co.kr/webapi/sales_search/api/goodsSales.asp";
