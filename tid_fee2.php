<?php
	...
	$sql_common = " from g5_device_20240701 where ".$adm_sql;
	/*
	if ($is_admin != 'super')
			...
			<ul>
				...
				<li>
					...
					<div>
						...
						<input type="text" name="mb_1_name" value="<?php echo $mb_1_name ?>" id="mb_1_name" class="frm_input" size="7" placeholder="본사명" style="width:60px;">
						<?php } ?>
						<?php if($member['mb_level'] > 7) { ?>
						<input type="text" name="mb_2_name" value="<?php echo $mb_2_name ?>" id="mb_2_name" class="frm_input" size="7" placeholder="지사명" style="width:60px;">
						<?php } ?>
						<?php if($member['mb_level'] > 6) { ?>
						<input type="text" name="mb_3_name" value="<?php echo $mb_3_name ?>" id="mb_3_name" class="frm_input" size="7" placeholder="총판명" style="width:60px;">
						<?php } ?>
						<?php if($member['mb_level'] > 5) { ?>
						<input type="text" name="mb_4_name" value="<?php echo $mb_4_name ?>" id="mb_4_name" class="frm_input" size="7" placeholder="대리점명" style="width:60px;">
						<?php } ?>
						<?php if($member['mb_level'] > 4) { ?>
						<input type="text" name="mb_5_name" value="<?php echo $mb_5_name ?>" id="mb_5_name" class="frm_input" size="7" placeholder="영업점명" style="width:60px;">
						<?php } ?>
					</div>
				</li>
				<li>
